...
class DatasetCatalog(object):
    DATA_DIR = "datasets"
    DATASETS = {
        "coco_bottlewine_train": {
            "img_dir": "bottlewine/train",
            "ann_file": "bottlewine/train_annotations.json",
        },
        "coco_bottlewine_val": {
            "img_dir": "bottlewine/train",
            "ann_file": "bottlewine/val_annotations.json",
        },
        "coco_bottlewine_test": {
            "img_dir": "bottlewine/test",
            "ann_file": "bottlewine/test_annotations.json"
        },
        "coco_2017_train": {
